    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color: #337ab7;" href=""><strong>DSC STIMATA</strong></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?page=data_mahasiswa"><i class="fa fa-address-card-o"></i> Data Mahasiswa</a>
                                </li>
                                <li>
                                    <a href="?page=project"><i class="fa fa-tasks"></i> Project</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="?page=event"><i class="fas fa-calendar-alt"></i> Event / Workshop</a>
                        </li>
                        <li>
                            <a href="?page=galeri"><i class="fa fa-camera"></i> Image Gallery</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
